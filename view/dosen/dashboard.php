...
$dosen = mysqli_fetch_assoc(mysqli_query($connection, "SELECT * FROM dosen WHERE id = $result[user_id]"));
                            ...
                            <div class="card-body" style="flex-direction: column; align-items: flex-start;">
                                <div style="display: flex;">
                                    ...
                                    <div class="display: column" style="margin-left: 30px">
                                        ...
                                        <h1 style="margin-top: -5px; font-weight: bold"><?php echo 12 ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" style="flex-direction: column; align-items: flex-start;">
                                <div style="display: flex;">
                                    ...
                                    <div class="display: column" style="margin-left: 30px">
                                        ...
                                        <h1 style="margin-top: -5px; font-weight: bold"><?php echo 13 ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-md-7">
                        <div class="jumbotron" style="background-color: white">
                            <h5 style="font-weight: bold; margin-top: -25px; margin-bottom: 20px">Baru Ditambahkan</h5>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">Mata Kuliah</th>
                                        <th scope="col" style="width: 125px;">Kelas</th>
                                        <th scope="col" style="width: 100px;">Judul</th>
                                        <th scope="col" style="width: 150px;">Deadline</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $tugas = mysqli_query($connection, "SELECT * FROM daftar_tugas WHERE dosen_id = $dosen[id] ORDER BY id DESC LIMIT 5");
